...
\node[below=0.3cm of privatesector, font=\footnotesize, align=center] {$\Delta(\NFA_{\text{Private}}) = +G$\\Net financial asset created};
	...
	\node[process, fill=orange!20, right=of qe1] (qe2) {Fed buys bonds\\credits bank reserves};
	\node[process, fill=orange!20, right=of qe2] (qe3) {Households hold\\deposits $D$};
